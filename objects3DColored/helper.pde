...
void printProjecao() {
  ...
  case 3:
    ...
    text("um ponto de fuga", width-250, 37*1.5);
    break;
  case 4:
    text("  Perspectiva com", width-250, 37);
    text("dois pontos de fuga", width-250, 37*1.5);
    break;
  }
}
...
void helpMenu() {
  ...
  text("o: Mudar algoritmo de pintura das faces", 10, 10 + 17 * (x++));
